...
c.url.start_pages = ['https://nedra1998.github.io/Bento/']
...
# Bindings for bang search engines
config.bind('!', 'set-cmd-text :open -t -r !')

# Bindings for using bitwarden password manager
